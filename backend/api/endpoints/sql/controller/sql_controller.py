...
class AlarmController:
    ...
    async def load_all_by_sql_statement(self, payload: SqlExecutionPayload, user_uuid: Annotated[str | None, Header()] = None) -> SqlExecutionResult:
    ...
    async def load_single_by_sql(self, payload: SqlExecutionPayload, user_uuid: Annotated[str | None, Header()] = None) -> SqlExecutionResult:
    ...
    async def insert_by_sql(self, payload: SqlExecutionPayload, user_uuid: Annotated[str | None, Header()] = None) -> SqlExecutionResult:
    ...
    async def update_by_sql(self, payload: SqlExecutionPayload, user_uuid: Annotated[str | None, Header()] = None) -> SqlExecutionResult:
    ...
    async def delete_by_sql(self, payload: SqlExecutionPayload, user_uuid: Annotated[str | None, Header()] = None) -> SqlExecutionResult:
